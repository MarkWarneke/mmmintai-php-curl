...
/**
 * FahrzeugscheinXmlSasToken Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FahrzeugscheinXmlSasToken implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FahrzeugscheinXmlSasToken';
    ...
    {
        $this->container['sastoken'] = isset($data['sastoken']) ? $data['sastoken'] : '';
    }
    ...
    {
        return $this->container['sastoken'];
    }
    ...
    {
        $this->container['sastoken'] = $sastoken;
