...
/**
 * DetectionCroppedImageResult Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DetectionCroppedImageResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DetectionCroppedImageResult';
    ...
    {
        $this->container['detections'] = isset($data['detections']) ? $data['detections'] : null;
    }
     ...
     * Sets detections
     *
     * @param null[] $detections detections
     *
     * @return $this
     */
